...
/**
 * Servlet implementation class add_external
 */
@WebServlet("/add_external")
public class add_external extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps = con
					.prepareStatement("insert into tbl_external(company_name,company_email,company_address,drive_date,drive_time,drive_description,user_mail_id) values(?,?,?,?,?,?,?)");
