...
/**
 * Servlet implementation class add_webinar
 */
@WebServlet("/add_webinar")
public class add_webinar extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps = con
					.prepareStatement("insert into tbl_webinar(company_name,company_email,company_address,drive_date,drive_time,drive_description,user_mail_id) values(?,?,?,?,?,?,?)");
