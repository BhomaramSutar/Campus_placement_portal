	...
	<div class="container">
		<div class="row d-flex justify-content-center">
			<div class="menu-content pb-60 col-lg-7">
				...
				<% int id=0; %>
				<form role="form" action="uploadfile" 
					method="post">
					<div class="form-group">
						...
						<tr>
								...
								<td class="col-md-6"><input type="text"
									...
									id="txt_Page" placeholder="Enter Company Name"></td>
							</tr>
							<tr>
								<td class="col-md-2"><label for="txt_Pquantity"
								...
								<td class="col-md-6"><input type="text"
									...
									id="txt_Page" placeholder="Enter Company Email"></td>
							</tr>
							<tr>
								<td class="col-md-2"><label for="txt_Pquantity"
							...
							<tr>
								...
								<td class="col-md-6"><input type="Time"
									...
									id="txt_Page" placeholder="Enter Age"></td>
							</tr>
							...
							<tr>
								...
								<td class="col-md-6"><textarea class="form-control"
										...
										placeholder="Enter Detials"></textarea></td>
							</tr>
							<tr>
								<td class="col-md-2"><label for="txt_Pdescription"
									style="color: White; font-size: 18px;">Job Link </label></td>
								<td class="col-md-6"><input type="text" class="form-control"
										name="txt_link" required id="txt_link"
										placeholder="Enter Link"/></td>
							</tr>
							<tr>
						...
						<tr>
								...
								<td class="col-md-6"><input type="text"
									...
									id="txt_Page" placeholder="Enter 10th Marks"></td>
							</tr>
							<tr>
								<td class="col-md-2"><label for="txt_Pquantity"
								...
								<td class="col-md-6"><input type="text"
									...
									id="txt_Page" placeholder="Enter 12th Marks"></td>
							</tr>
							<tr>
								<td class="col-md-2"><label for="txt_Pquantity"
								...
								<td class="col-md-6"><input type="text"
									...
									id="txt_Page" placeholder="Enter Graduation Marks"></td>
							</tr>
							<tr>
								<td class="col-md-2"><label for="txt_Pquantity"
								...
								<td class="col-md-6"><input type="text"
									...
									id="txt_Page" placeholder="Enter Post Graduation Marks"></td>
							</tr>
