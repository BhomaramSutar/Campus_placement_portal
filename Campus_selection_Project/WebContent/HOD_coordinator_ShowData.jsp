...
<body>	
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          <li class="menu-active"><a href="HODHomePage.jsp">HOME</a></li>
				        
				          <li><a href=HOD_coordinator_ShowData.jsp>Coordinator Show </a></li>
				            <li><a href="HOD_Student_ShowData.jsp">Student Show</a></li>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-10">
							<div class="title text-center">
								<h1 class="mb-10 text-white">Show Coordinator Data</h1>
								<br>
							</div>
	       ...
	       <tr>
		    ...
		    <th class="col-md-5" style="width:1%"><label for="txt_Pid" style="color:White;">Gender</label></th>
		    <th class="col-md-1" style="width:97%"><label for="txt_Pid" style="color:White;">Email ID</label></th>
		    <th class="col-md-5" style="width:1%"><label for="txt_Pid" style="color:White;">Mobile_No</label></th>
