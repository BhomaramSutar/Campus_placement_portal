			  ...
			  <header id="header" id="home">
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				     <marquee> Jspm Imperial College Of Engineering And Research Wagholi </marquee>
				      </div>
			...
			<tr>
								...
								<tr>
									...
									<td><input type="text" required  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"
													name="txtEmail" class="form-control" /></td>
								</tr>
								<tr>
									...
									<td ><input type="text" required pattern="[7-9]{1}[0-9]{9}"  maxlength="10" title="Not a valid Phone Number"
										name="txtContact" class="form-control" /></td>
								</tr>
								<tr>
